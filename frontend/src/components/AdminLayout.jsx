    ...
    <div className="flex min-h-screen bg-slate-950">
      ...
      `}>
        ...
        <div className="p-4 border-t border-slate-800">
          ...
          <a
            href="/manual-superadmin.html"
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-slate-800 hover:text-white transition-colors w-full text-sm mb-1">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
