...
export default function Layout({ children, title, subtitle }) {
  ...
  const navItems = [
    ...
    { to: '/financeiro', label: 'Financeiro', planos: ['pro', 'business'], roles: ['admin', 'super_admin'], icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /> },
    ...
    { to: '/wa-atendimento', label: 'Atendimento WA', planos: ['pro', 'business'], icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /> },
  ];
    ...
    <div className="flex min-h-screen" style={{ backgroundColor: 'var(--bg)' }}>
      ...
      `} style={{ backgroundColor: 'var(--surface)', borderColor: 'var(--bd)' }}>
        ...
        <div className="p-3 border-t space-y-0.5" style={{ borderColor: 'var(--bd)' }}>
          ...
          <SidebarBtn href={['admin','super_admin'].includes(user?.role) ? '/manual-admin.html' : '/manual-usuario.html'} label="Manual">
...
function SidebarBtn({ href, onClick, label, children }) {
