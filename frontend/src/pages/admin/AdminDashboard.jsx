...
const PLANO_COLOR = { solo: 'bg-slate-700 text-slate-200', pro: 'bg-blue-900 text-blue-300', business: 'bg-purple-900 text-purple-300' };
...
export default function AdminDashboard() {
  ...
  const porPlano = ['solo', 'pro', 'business'].map(p => ({
    plano: p,
